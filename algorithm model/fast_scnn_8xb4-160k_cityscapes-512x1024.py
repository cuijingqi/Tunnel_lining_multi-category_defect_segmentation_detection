...
default_hooks = dict(
    checkpoint=dict(by_epoch=False, interval=1000,save_best='mIoU', type='CheckpointHook'),
...
launcher = 'none'
load_from = './Cmine/checkpoint/fast_scnn_lr0.12_8x4_160k_cityscapes_20210630_164853-0cec9937.pth'
log_level = 'INFO'
...
train_cfg = dict(
    max_iters=17607, type='IterBasedTrainLoop', val_interval=1000)
...
work_dir = './Cmine/outputs/fast_scnn_8xb4-160k_cityscapes-512x1024'
